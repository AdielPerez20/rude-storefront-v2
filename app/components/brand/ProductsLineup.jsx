...
const MOCK_PRODUCTS = [
  {
    handle: 'electrolytes-lemon-lime',
    titleHe: 'אלקטרוליטים — לימון ליים',
    titleEn: 'Electrolytes — Lemon Lime',
    image: '/images/product-electrolytes-lemon-lime.png',
    price: 149,
    compareAt: 169,
  },
  {
    handle: 'electrolytes-pink-lemonade',
    titleHe: 'אלקטרוליטים — לימונדה ורודה',
    titleEn: 'Electrolytes — Pink Lemonade',
    image: '/images/product-electrolytes-pink-lemonade.png',
    price: 149,
    compareAt: null,
  },
  {
    handle: 'creatine-pomegranate-berries',
    titleHe: 'קריאטין — רימון ופירות יער',
    titleEn: 'Creatine — Pomegranate Berries',
    image: '/images/product-creatine-pomegranate.png',
    price: 189,
    compareAt: null,
  },
  {
    handle: 'creatine-duo-bundle',
    titleHe: 'באנדל קריאטין · כפול',
    titleEn: 'Creatine Duo Bundle',
    image: '/images/product-creatine-duo.png',
    price: 339,
    compareAt: 378,
  },
];
